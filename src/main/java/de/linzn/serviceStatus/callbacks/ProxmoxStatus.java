...
public class ProxmoxStatus extends AbstractCallback {

    private static boolean proxmoxStatus = false;
    ...
    public static boolean getProxmoxStatus() {
    ...
    public void callback(OperationOutput operationOutput) {
        proxmoxStatus = (boolean) operationOutput.getData();
        WebStatusOperation webStatusOperation = (WebStatusOperation) operationOutput.getAbstractOperation();
        AppLogger.debug("PROXMOX " + webStatusOperation.getStatusHost() + ":" + webStatusOperation.getStatusPort() + " status " + (proxmoxStatus ? Color.GREEN + "ONLINE" : Color.RED + "OFFLINE"));
    }
